...
Scene_Dendo.prototype.create = function() {
    ...
    this.createMenuNameWindow("でんどう");
...
Scene_Dendo.prototype.createInfoWindow = function() {
	...
	this._infoWindow.addCommand("とじる","cancel",true);
...
Window_DendoList.prototype.makeItemList = function() {
	...
	const listData = {}
    listData["19"] =[0,"ウィングラプター"];
    listData["43"]=[1,"シヴァ"];
    listData["45"]=[2,"くろのワルツ１ごう"];
    listData["72"]=[3,"ミストドラゴン"];
    listData["73"]=[4,"イフリート"];
    listData["73"]=[5,"ディアボロス"];
    listData["97"]=[6,"ラムウ"];
    listData["98"]=[7,"マギサ＆テュポーン"];
    listData["119"]=[8,"ファントム"];
    listData["121"]=[9,"ナムタルウトク"];
    listData["148"]=[10,"フェンリル&タイタン"];
    listData["149"]=[11,"ブラザーズ"];
    listData["172"]=[12,"カーバンクル"];
    listData["173"]=[13,"デモンズウォール"];
    listData["174"]=[14,"リッチ"];
    listData["198"]=[15,"ゴーレムききいっぱつ"];
    listData["199"]=[16,"グツコー"];
    listData["220"]=[17,"しんせいメーガスさんしまい"];
    listData["241"]=[18,"ザ・ソウルケージ"];
    listData["260"]=[19,"エルヴィオレ"];
    listData["261"]=[20,"リクイドフレイム"];
    listData["279"]=[21,"ガーディアン"];
    listData["284"]=[22,"モーターボール"];
    listData["285"]=[23,"マリリス"];
    listData["290"]=[24,"アイアンクロー"];
    listData["317"]=[25,"オーディン"];
    listData["315"]=[26,"オルトロス"];
    listData["316"]=[27,"ベイガン"];
    listData["336"]=[28,"シルドラ"];
    listData["337"]=[29,"ボトムスウェル"];
    listData["357"]=[30,"カトブレパス"];
    listData["338"]=[31,"カロフィステリ"];
    listData["381"]=[32,"リヴァイアサン"];
    listData["382"]=[34,"オクトマンモス"];
    listData["398"]=[33,"シリオン"];
    listData["399"]=[35,"クラーケン"];
    listData["422"]=[36,"アレクソウル"];
    listData["423"]=[37,"JENOVA"];
    listData["444"]=[38,"アトモス"];
    listData["445"]=[39,"ユウナレスカ"];
    ...
    listData["16"]=[60,"せきぞう"];
    listData["17"]=[61,"アルケオダイノス"];
    listData["18"]=[62,"ガルキマセラ"];
    listData["40"]=[63,"ピスコディーモン"];
    listData["41"]=[64,"ツインヘッド"];
    listData["42"]=[65,"コキュートス"];
    listData["66"]=[66,"アサルトドアー"];
    listData["67"]=[67,"ラルヴァラーヴァ"];
    listData["68"]=[68,"ダークウィザード"];
    listData["94"]=[69,"マテリアキーパー"];
    listData["95"]=[70,"ひりゅうそう"];
    listData["96"]=[71,"アバドン"];
    listData["120"]=[72,"ソウルイーター"];
    listData["111"]=[73,"サムライソウルズ"];
    listData["112"]=[74,"ウルフラマイター"];
    listData["141"]=[75,"サポテンダー"];
    listData["139"]=[76,"ドルムキマイラ"];
    listData["144"]=[77,"サボテンダー"];
    listData["145"]=[78,"スラッグクロウラ"];
    listData["167"]=[79,"マシンヘッド"];
    listData["168"]=[80,"ミミック"];
    listData["170"]=[81,"グランインセクト"];
    listData["171"]=[82,"スフィンクス"];
    listData["195"]=[83,"ラルヴァイマーゴ"];
    listData["196"]=[84,"ニンジャ"];
    listData["197"]=[85,"ボムふさい"];
    listData["215"]=[86,"ウェアウルフ"];
    listData["216"]=[87,"ヤーン"];
...
Window_DendoInfo.prototype.drawRecord = function() {
    ...
    if(this._page == 0){
        ...
        this.drawText("プレイタイム：", Math.floor(this.innerWidth/2), Math.floor(this.innerHeight/3*2));
