...
(() => {
    ...
    Scene_Battle.prototype.isSkillOrItemCommandSelecting = function() {
        return this._skillWindow.active || this._itemWindow.active || this._actorSubCommandWindow.active || this._subActorWindow.active;
    };
    ...
    BattleManager.playActorInputSe = function() {
        ...
        if(!BattleManager._currentActor.isStateAffected(16) && (BattleManager._currentActor.isStateAffected(28)||BattleManager._currentActor.tp >= 100)){
            se.name = "FF8 special ready";
        }
