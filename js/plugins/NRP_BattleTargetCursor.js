...
(function() {
    ...
    Window_BattleEnemyName.prototype.showTargetName = function() {
        ...
        if (spriteset && !BattleManager.isAllEnemySelecting()) {
            dispCursorSprite(spriteset._enemyCursorSprite, sprite);
        }else if(spriteset && BattleManager.isAllEnemySelecting()){
            hideCursorSprite(spriteset._enemyCursorSprite, sprite);
        }
    ...
    Window_BattleActorName.prototype.showTargetName = function() {
        ...
        const spriteset = getSpriteset();
        if (spriteset && !BattleManager.isAllActorSelecting()) {
            dispCursorSprite(spriteset._actorCursorSprite, sprite);
        }else if(spriteset && BattleManager.isAllActorSelecting()){
            hideCursorSprite(spriteset._actorCursorSprite, sprite);
        }
