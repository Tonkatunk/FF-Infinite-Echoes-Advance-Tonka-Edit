...
(function() {
    ...
    Sprite_Battler.prototype.setHome = function(x, y) {
        ...
        if(this._battler.isActing() && BattleManager.releaseEnemy()>0){
            this.x = Graphics.boxWidth/6*5;
            this.y = Graphics.boxHeight/6*5;
            this._formationX = 0;
            this._formationY = 0;
        }
    };
