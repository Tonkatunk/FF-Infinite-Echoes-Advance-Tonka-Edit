...
Game_Party.prototype.bountyInfo = function() {
    var data = [
        ...
        ["Sanubia Desert","A,154","Cactuar",1096,24], //とうぞくのこて
        ["Sanubia Desert","W,232","Gorgimera",1097,24], //きんのたてごと
        ["Sanubia Desert","I,83","Sabotender",1098,24], //きんのかたまり
        ["Sanubia Desert","A,177","Landworm",1099,24], //シュシュ
        ["Pyramid","I,92","Omega Prototype",1100,30], //まどうせき
        ["Pyramid","A,17","Mimic",1101,30], //ゴールドシールド
        ["Pyramid","A,206","グランインセクト",1102,30], //ほのおのゆびわ
        ["Pyramid","A,56","スフィンクス",1103,30], //はくしきのガウン
        ["Fire Cave","A,208","ラルヴァイマーゴ",1104,36], //サンゴのゆびわ
        ["Fire Cave","W,67","ニンジャ",1105,36], //かげぬい
        ["Fire Cave","A,70","マザーボム",1106,36], //あかいドレス
