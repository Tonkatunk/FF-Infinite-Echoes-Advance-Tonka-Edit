...

{
	...
	if (pauseSignToRight) {
		...
		Window.prototype._refreshPauseSign = function() {
			...
			this._pauseSignSprite.move(this._width-24 + pauseSignOffsetX, this._height-12 + pauseSignOffsetY);
		};
	}
...
*/
		...
		Window_StatusEquip.prototype.arrowCursorPadding = function() {
			return false;
		};
	...
	Sprite_EnemyCursor.prototype.setup = function(target) {
		this._battlerObject = target._battler;
		this._target = target;
	};
	...
	Sprite_EnemyCursor.prototype.updatePattern = function() {
		this.visible = this._battlerObject.isSelected();
		if (this.visible) {
